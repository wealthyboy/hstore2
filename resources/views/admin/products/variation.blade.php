    ...
    <div class="col-md-9 col-xs-9 col-sm-9">
        <div class="row">
            ...
            <div class="col-md-3 col-xs-6 col-sm-6">
                <div class="form-group label-floatin">
    ...
    <div id="variation-panel" data-id="{{ $counter }}" class="hide v-panel">
        ...
        <div class="col-md-12">
            <div class="form-group label-floating is-empty">
                ...
                <input name="variation_name[{{ $counter }}]" type="text" value="{{ old('name') }}" class="form-control">
        ...
        <div class="col-md-3">
            <div class="form-group label-floating">
                ...
                <input class="form-control  pull-right" name="variation_sale_price_starts[{{ $counter }}]" id="datepicker" type="date">
                <span class="material-input"></span>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div id="j-drop" class="j-drop">
                    <input accept="image/*" onchange="handleFiles(this,'variation_images[{{ $counter }}][]')" class="upload_input" multiple="true" type="file" id="upload_file_input" name="product_image" />
                    <div class=" upload-text  {{ $counter }}">
                        <a class="" href="#">
                            <img class="" src="/backend/img/upload_icon.png">
