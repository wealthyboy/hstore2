                     ...
                     <div class="row">
                        <div class="col-md-8">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group label-floating {{ null !== $product ? '': 'is-empty' }}">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <textarea name="meta_description" id="" class="form-control" rows="10">{{ isset($product) ? $product->meta_description : old('meta_description') }}</textarea>
                                 </div>
                              </div>
                           </div>
