                                                      ...
                                                      <tr>
                                                         ...
                                                         <td valign="top" align="center">
                                                            <table class="tableTxt" width="252" cellspacing="0" cellpadding="0" border="0" align="left">
                                                               ...
                                                               <tr>
                                                                  <td colspan="3" class="RegularTextTD" data-link-style="text-decoration:none; color:#67bffd;" data-link-color="RegularLink" data-color="RegularTXT" style="margin-left: 3px;color: #727e8d;font-family: sans-serif;font-size: 13px;font-weight: lighter;line-height: 23px;"> {{ $order->first_name }} {{ $order->last_name }}  <br />{{ $order->address }}<br /> {{ $order->city }} &nbsp;<br /> {{ $order->state }},{{ $order->country }}&nbsp;<br/> <br/>  Shipping Name: {{null !==  optional($order->shipping)->parent ?  optional(optional($order->shipping)->parent)->name : '' }}  <br/> Delivery Option: {{ optional($order)->delivery_option }}</td>
                                                               </tr>
                                                               <tr>
                                                                  <td colspan="3" style="font-size:0;line-height:0;" height="25"></td>
                                                               </tr>
                                                 ...
                                                 <th class="stack2" style="margin: 0px; padding: 0px; border-bottom: 1px solid rgb(200, 198, 198);" data-border-bottom-color="borderColor" width="209">
                                                   <table class="table60032" width="209" cellspacing="0" cellpadding="0" border="0" align="center">
                                                      ...
                                                      <tr>
                                                         ...
                                                         <br/>{{ optional($ordered_product->product_variation)->name  ??  optional(optional($ordered_product->product_variation)->product)->product_name }} <br /><br/> @if (null !== $ordered_product->product_variation)
                              ...
                              <td class="table600st" style="border:1px solid #f4f4f4; background-color: #f4f4f4;min-width:629px;" align="center">
                                 <table class="table600" width="610" cellspacing="0" cellpadding="0" border="0" align="center">
                                    ...
                                    <tr>
                                       ...
                                       <td class="moptd" data-link-style="text-decoration:none; color:#ffffff;" data-link-color="MailingOptionsLink" data-color="MailingOptionsTXT" style="color: rgb(13, 14, 12); font-family: sans-serif; font-size: 12px; text-align: center; line-height: 170%;">All rights Reserved Hautesignatures</td>
                                    </tr>
