<template>
    <div class="">
        ...
        <template v-if="message">
            ...
            <div class="text-center">
                <h3>{{ message }} </h3>
                <span v-if="Object.keys(errors).length !== 0"><a href="/password/reset"> Click here to request
                        another</a></span>
            </div>
            </p>
        </template>
            ...
            <template v-if="!validating && allow_change_password">
                <p class="form-field-wrapper">
                    ...
                    <input id="email" v-model="form.email" @input="removeError($event)" @blur="vInput($event)"
                        ...
                        class="input--lg form-full custom-control-input required" name="email">
                ...
                <p class="form-field-wrapper">
                    ...
                    <input id="new_password" v-model="form.password" @input="removeError($event)" @blur="vInput($event)"
                        type="password" class="input--lg form-full required" name="password">
                ...
                <p class="form-field-wrapper">
                    ...
                    <input id="password_confirmation" v-model="form.password_confirmation" @input="removeError($event)"
                        ...
                        class="input--lg form-full required" name="password_confirmation">
